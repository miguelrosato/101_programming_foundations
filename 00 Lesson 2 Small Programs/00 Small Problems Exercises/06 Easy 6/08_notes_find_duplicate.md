...
Input: an array
Output: a value (integer or string), which is repeated through the elements of the array 
...
## Data. Data Structure
Select the elements that repeat. To select the elements that repeat, we can use the count method at eacgh iteration of the select method.
return the initial value of the new array 
