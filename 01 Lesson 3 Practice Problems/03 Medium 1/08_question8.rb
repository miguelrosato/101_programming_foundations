...
# The method reassign the "age" key, the value of the sum of the actual
# "age" key value plus 42 and it reassign each "gender" key with the
# value "other", mutating the original Hash
