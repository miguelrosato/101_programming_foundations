...
# The method create new variables internally that recall the objects of the external variables. However, the reassignment inside the method does not alter the original variables outside of the scope of the method, so the original object ids are not altered.